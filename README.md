...
|   └── ...
├── config.py                 # GPT-2 config (Small / Medium / Large / XL)
├── dataset.py                # Tokenization, sliding window, format & collate
├── gpt.py                    # GPT-2 model implementation
...
An overview of the GPT-2 model architecture:

<br>
<p align="center">
    <img src="./images/gpt2-xl.png" height="555" />
    <br>
    <em><strong>GPT-2 XL</strong></em>
</p>
<br>

| Model        | Context Length | Embedding Dimension | Heads | Layers | Size  |
|:-------------|----------------|:--------------------|:------|--------|-------|
| GPT-2 SMALL  | 1024           | 768                 | 12    | 12     | 124M  |
| GPT-2 MEDIUM | 1024           | 1024                | 16    | 24     | 355M  |
| GPT-2 LARGE  | 1024           | 1280                | 20    | 36     | 774M  |
| GPT-2 XL     | 1024           | 1600                | 25    | 48     | 1558M |
...
*the-verdict* from the book to pretrain *GPT-2 SMALL* (124M) and see how it performs. You can also use other datasets if
you want.
...
I used an NVIDIA GeForce RTX 4090 GPU (24GB VRAM) to fine‑tune *GPT-2 XL* (1.5B) for 2 epochs (about 169 minutes).
...
<br><br>
<em><strong>My fine-tuned weight:</strong></em> [GPT-2 XL](https://huggingface.co/LCZ-ctrl/LLMs-finetuned)
